Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    # mysql -u root -p123qwe -h localhost -e "DROP DATABASE node;DROP DATABASE test;CREATE DATABASE IF NOT EXISTS node;CREATE DATABASE IF NOT EXISTS test;GRANT ALL PRIVILEGES ON node.* TO 'api'@'localhost' IDENTIFIED BY '123qwe';GRANT ALL PRIVILEGES ON test.* TO 'api'@'localhost' IDENTIFIED BY '123qwe'; FLUSH PRIVILEGES;"
